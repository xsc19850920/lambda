...
public class Endecrypt {
	...
	private byte[] getEnKey(String spKey) {
		...
		try {
			...
			byte[] desKey1 = md5.digest(spKey.getBytes("UTF-16LE"));
			desKey = new byte[24];
			System.arraycopy(desKey1, 0, desKey, 0, desKey1.length);  
//			int i = 0;
...
//			}
	...
	public String getURLEncode(String src) {
		String requestValue = "";
		try {
			requestValue = URLEncoder.encode(src,"UTF-16LE");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return requestValue;
	...
	public String getURLDecoderdecode(String src) {
		String requestValue = "";
		try {
			requestValue = URLDecoder.decode(src,"UTF-16LE");
		} catch (Exception e) {
			e.printStackTrace();
		}
		return requestValue;
	...
	public static void main(String[] args) {
		...
		String oldString = "毒素发fa sdfs	da21@K #RJ$#K $R <HTML> </HTML> > \r\n";
		String SPKEY = "毒素发fa sdfs	da21@K #RJ$#K $R <HTML> </HTML> >123456789456456456fdas456fd4a56fdsafdas";
